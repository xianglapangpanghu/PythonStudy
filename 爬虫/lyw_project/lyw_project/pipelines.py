...
class LywProjectPipeline(object):
    ...
    def insert_item(self,cursor,item):
        sql = "insert into article(title,author,put_time,content,origin) values(%s,%s,%s,%s,%s)"
        args = (item['title'],item['author'],item['put_time'],item['content'],item['origin'])
